...
#define MISC_HANDLE_MTLINK_VERSION       (MISC_HANDLE_MTLINK_CMD_START + 0)
...
#define MISC_HANDLE_MTLINK_DEVICE_TYPE   (MISC_HANDLE_MTLINK_CMD_START + 5)
#define MISC_HANDLE_MTLINK_PCI_INFO      (MISC_HANDLE_MTLINK_CMD_START + 6)
#define MISC_HANDLE_MTLINK_TOPLOGY       (MISC_HANDLE_MTLINK_CMD_START + 7)
#define MISC_HANDLE_MTLINK_CMD_CNT       (MISC_HANDLE_MTLINK_TOPLOGY + 1)

#define MTGPU_MISC_MTLINK_VERSION_GET \
	_IOR('M', (MISC_HANDLE_MTLINK | MISC_HANDLE_MTLINK_VERSION), unsigned int)
...
#define MTGPU_MISC_MTLINK_ERROR_COUNT_GET \
	_IOR('M', (MISC_HANDLE_MTLINK | MISC_HANDLE_MTLINK_ERR_CNT), struct mtlink_enable_state)
#define MTGPU_MISC_MTLINK_ERROR_COUNT_RESET \
	_IOW('M', (MISC_HANDLE_MTLINK | MISC_HANDLE_MTLINK_RESET_ERR), unsigned int)
#define MTGPU_MISC_MTLINK_REMOTE_DEVICE_TYPE_GET \
	_IOR('M', (MISC_HANDLE_MTLINK | MISC_HANDLE_MTLINK_DEVICE_TYPE), \
	     struct mtlink_remote_device_type)
#define MTGPU_MISC_MTLINK_REMOTE_DEVICE_PCI_INFO_GET \
	_IOR('M', (MISC_HANDLE_MTLINK | MISC_HANDLE_MTLINK_PCI_INFO), \
	     struct mtlink_remote_device_info)
#define MTGPU_MISC_MTLINK_TOPLOGY_GET \
	_IOR('M', (MISC_HANDLE_MTLINK | MISC_HANDLE_MTLINK_TOPLOGY), struct mtlink_toplogy)
